    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8 bg-black">
      ...
      <div className="col-span-2 px-5 md:mt-48 lg:mt-40">
        ...
        <div>
          ...
          <a
            href="#contact"
            className="px-6 py-3 w-full rounded-x-l mr-4 border broder-gray-400 hover:bg-gradient-to-br from-orange-500 to-pink-500 text-white hover:border-none">
            Contact
          </a>
        </div>
      </div>
